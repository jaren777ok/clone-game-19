    ...
    <div className="min-h-screen bg-background relative overflow-hidden py-16">
      ...
      <div className="relative z-10 container mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto space-y-8">
          ...
          {/* Manual Check Button - Dark background with elegant wide design */}
          {canCheckVideo && onManualCheck && (
            <div className="space-y-6">
              {/* Container with dark background and wide proportions */}
              <div className="relative mx-auto max-w-2xl">
                {/* Subtle outer glow */}
                <div className="absolute inset-0 bg-gradient-to-r from-green-500/20 via-green-600/30 to-emerald-600/20 rounded-2xl blur-lg opacity-40"></div>
                
                {/* Dark container with wide proportions */}
                <div className="relative bg-black/80 p-6 rounded-2xl border border-green-500/30 backdrop-blur-md shadow-2xl">
                  <Button
                    onClick={onManualCheck}
                    disabled={isChecking}
                    size="lg"
                    className="w-full bg-gradient-to-r from-green-500 via-green-600 to-emerald-600 hover:from-green-400 hover:via-green-500 hover:to-emerald-500 focus:from-green-400 focus:via-green-500 focus:to-emerald-500 text-white font-bold py-4 px-24 rounded-xl shadow-lg shadow-green-500/25 transform hover:scale-[1.02] focus:scale-[1.02] transition-all duration-300 text-lg disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 border-0 relative overflow-hidden"
                  >
                    {/* Subtle shine effect */}
                    <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/15 to-transparent -skew-x-12 animate-[shimmer_2s_infinite]"></div>
